      ...
      <div class="content-box">
        <div class="presell_module_w">
          <div class="presell_module_left">
            ...
            <clamp :content="$t('preSale.presaleInfo')" class="content" />
          </div>
          <div class="presell_module_right">
            <img
              ...
              class="page_gif"
              :data-default_url="
                require('@/assets/images/presell/gif/module1.png')
              "
              :data-gif_url="require('@/assets/images/presell/gif/module1.gif')"
              alt=""
            />
          </div>
        </div>
        ...
        <div class="content-box presell-box">
          ...
          <div class="presell_time_info_right">
            <img
              ...
              class="page_gif"
              :data-default_url="
                require('@/assets/images/presell/gif/module2.png')
              "
              :data-gif_url="require('@/assets/images/presell/gif/module2.gif')"
              alt=""
            />
          </div>
        </div>
