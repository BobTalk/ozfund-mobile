  ...
  <div class="presell-module_1">
    <div class="img">
      ...
      <img
          ...
          :data-default_url="require('@/assets/images/presell/gif/module1.png')"
    ...
    <clamp :content='$t("preSale.presaleInfo")'  class="info"/>
    ...
    <div class="sell-time">
      ...
      <div class="data-info">
        <img :src="require('@/assets/images/presell/gif/module2.png')" alt="" />
      </div>
    </div>
  </div>
</template>
