  ...
  <div class="home_module_four pc_show">
    <div class="w">
      <div class="home_modul_tit">
        <h3>{{ $t("home.token")}}{{ $t("global.ozc") }}{{$t("home.and")  }}{{$t("global.toto")  }}</h3>
        <p>
          {{ $t("home.tokenInfo") }}
        </p>
      </div>
      <div class="module_card" ref="homeModuleThree">
        <div class="card_i">
          <div class="card_i_top">
            <img
              v-animation
              :data-default_url="require('@/assets/images/home/gif/ozc1.png')"
        ...
        <div class="card_i">
          <div class="card_i_top">
            ...
            <img
              v-animation
              :data-default_url="require('@/assets/images/home/gif/toto1.png')"
              class="card_i_top_img page_gif"
          ...
          <ul class="card_data">
            ...
            <li><p>{{ $t("home.marketValue") }}</p>
              <span>{{ ozcSupply }} OZC</span></li>
            <li><p>{{ $t("home.circulation") }}</p>
              <span>{{ ozcSupply }} OZC</span></li>
          </ul>
