      ...
      <div class="conversion_home_wrap">
        ...
        <div class="conversion_home_info">
          ...
          <div class="conversion_home_info_input">
            ...
            <button class="toto_exchange_ozc" @click="exchangeFn">
              {{ $t("home.exchange") }}
            </button>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...mapActions("Metamask", ["checkIfWalletIsConnected","exchangeTOTOforOzcoin"]),
    ...
    async exchangeFn() {
      ...
      if (accountAddr) {
        // 已连接钱包
        this.exchangeTOTOforOzcoin({amount:100,exchangeAddr:accountAddr}).then(() => {
