        ...
        <div v-if="type === 'b-o'" class="conversion_top">
          <div class="conversion_info">
            <div class="conversion_info_top">
              ...
              <span
                >{{ $t("purchaseAndPledge.quantity") }}：<i class="busd_number">{{
                  busdBalance || 0
                }}</i
                >
                {{ $t('global.busd') }}
          ...
          <div class="conversion_info">
            <div class="conversion_info_top">
              ...
              <span
                >{{ $t("purchaseAndPledge.quantity") }}：<i class="ozc_number"
                  >{{ ozcBalance || 0 }}{{ $t('global.ozc') }}</i
                ></span
              >
            </div>
            <div class="conversion_info_input">
        ...
        <div v-else class="conversion_top">
          <div class="conversion_info">
            <div class="conversion_info_top">
              <p>{{ $t("purchaseAndPledge.from") }}</p>
              <span
                >{{ $t("purchaseAndPledge.quantity") }}：<i class="ozc_number">{{ ozcBalance }}</i
                >
                {{ $t('global.ozc') }}
          ...
          <div class="conversion_info">
            <div class="conversion_info_top">
              <p>{{ $t("purchaseAndPledge.to") }}</p>
              <span
                >{{ $t("purchaseAndPledge.quantity") }}：<i class="busd_number">{{ busdBalance }}</i
                >BUSD
              </span>
            </div>
            <div class="conversion_info_input">
...
export default {
  ...
  methods: {
    ...
    mobileAuthorizationBtn() {
      console.log(this.address, "addresf");
