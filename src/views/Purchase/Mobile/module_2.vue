<template>
  <div class="purchase-module_2">
    <div class="img">
      <!-- <img src="../../../assets/images/purchase/gif/module2.png" alt="" />
       -->
       <img
    ...
    <p class="title">{{$t('purchaseAndPledge.obtain')}}&ensp;{{$t('global.ozc')}}&ensp;{{$t('purchaseAndPledge.stake')}}&ensp;{{$t('global.toto')}}</p>
    <p class="summary">{{$t('purchaseAndPledge.interestRateReference')}}：%</p>
    <!-- <p class="info">
      {{ $t('purchaseAndPledge.info') }}
      <br/>&ensp;{{ $t('purchaseAndPledge.note') }}
    </p> -->
    <clamp :content='$t("purchaseAndPledge.info")' class="info"/>
    <div class="btn-list">
