  ...
  <div class="client">
                  ...
                  <Popover placement="bottom">
                    ...
                    <template slot="content">
                      <div class="down_nav_modal">
                        <span
                          :class="{ active: childItem.key == childKey }"
                          :key="childItem.key"
                          v-for="childItem in item.children"
                          @click="childrenRouterCb(childItem)"
                        >
                          {{ $t(childItem.label) }}
                        </span>
                      </div>
    ...
    <div class="footer" :class="{ ru_public_foo: $i18n.locale === 'ru' }">
      <div class="list">
        ...
        ></span>
        <ul class="link-item">
          <li @click="jumpLink('https://www.ozfund.one')">
            {{ $t("footer.ozfund") }}
          </li>
          <li>｜</li>
          <li @click="jumpLink('http://ozbet.aucloudtest.com')">
            {{ $t("footer.ozbet") }}
          </li>
          <li>｜</li>
          <li @click="jumpLink('http://www.aupay.one/')">
            {{ $t("footer.auPay") }}
          </li>
          <li>｜</li>
          <li @click="viewePdf('Oz-White-Paper.pdf')">
            {{ $t("footer.whitepaper") }}
          </li>
          <li>｜</li>
          <li @click="viewePdf('Oz-clause.pdf')">
            {{ $t("footer.treaty") }}
          </li>
          <li>｜</li>
          <li @click="viewePdf('Oz-Privacy-Policy.pdf')">
            {{ $t("footer.privacy") }}
          </li>
        </ul>
        <p class="rights">
