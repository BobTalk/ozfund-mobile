<template>
  <div>
      ...
      <div class="header">
        ...
        <div class="right-box">
            ...
            <van-popup v-model="langeList" position="bottom">
              ...
              <template v-if="mobileOpen">
                <svg @click="clickMenu" t="1703476114895" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="22343" width=".44rem" height=".3rem"><path d="M453.44 512L161.472 220.032a41.408 41.408 0 0 1 58.56-58.56L512 453.44 803.968 161.472a41.408 41.408 0 0 1 58.56 58.56L570.56 512l291.968 291.968a41.408 41.408 0 0 1-58.56 58.56L512 570.56 220.032 862.528a41.408 41.408 0 0 1-58.56-58.56L453.44 512z" fill="#3D3D3D" p-id="22344"></path></svg>
              </template>
    ...
    <div class="wallet-box" :style="{
      ...
      <!-- v-if="!this.address" -->
      <span @click="mobileLineWallet" class="mobile_line_wallet">
