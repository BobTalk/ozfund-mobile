<template>
  <div>
    <div class="public_head w">
      ...
      <ul class="head_nav">
        <li
          ...
          :key="item.value"
          :class="navClass(item.value)"
        >
          <router-link
            v-if="item.value !== '/dynamic'"
            :to="item.value"
            tag="a"
    ...
    <div class="mobile_nav" :class="{ mobile_nav_open: mobileOpen }">
      ...
      <div
        :class="{ 'cur menu_info': this.mobileOpen === true, menu_info: true }"
      >
        <ul class="menu_info_list">
          <li
            v-for="item in navList"
            :key="item.value"
            :class="navClassMobile(item.value)"
    ...
    <!-- 公用底部 pc -->
    <div
      class="public_foo pc_show"
      :class="{ ru_public_foo: $i18n.locale === 'ru' }"
    >
      <div class="w">
    ...
    <div class="public_foo_mobile w mobile_show">
      <ul class="public_foo_mobile_ul">
        ...
        <li class="public_foo_mobile_li">
          <a
            class="public_foo_mobile_li_tit"
            target="_blank"
        ...
        <li class="public_foo_mobile_li">
          <p class="public_foo_mobile_li_tit">{{ this.$t("关于Ozfund") }}</p>
          <ul>
            <li>
              <a href="#" @click="viewePdf('Oz-White-Paper.pdf')">{{
                this.$t("白皮书")
